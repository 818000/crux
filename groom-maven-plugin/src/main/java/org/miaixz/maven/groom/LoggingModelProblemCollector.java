...
public class LoggingModelProblemCollector implements ModelProblemCollector {
    ...
    /**
     * Maven logger that receives collected model problems.
     */
    ...
    /**
     * Logs a model problem as a Maven warning.
     *
     * @param req the problem request supplied by Maven model building
     */
