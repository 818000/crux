...
public class Dependencies {
    ...
    /**
     * Dependencies indexed by their Maven management key and classifier.
     *
     * @see #add(Dependency)
     */
    ...
    /**
     * Builds the stable lookup key used by this container.
     *
    ...
    /**
     * Adds every dependency in the supplied list to this container.
     *
    ...
    /**
     * Adds one dependency to this container.
     *
    ...
    /**
     * Tests whether a dependency with the same lookup key is already present.
     *
    ...
    /**
     * Resolves a dependency by its lookup key.
     *
    ...
    /**
     * Copies the current dependency values into a list.
     *
