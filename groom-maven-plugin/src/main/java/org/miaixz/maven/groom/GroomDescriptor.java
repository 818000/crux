 ...
 * @since 1.0.0-beta-2
 */
public class GroomDescriptor {

    /**
     * Element handling values keyed by raw POM element name.
     */
    private final Map<String, ElementHandling> name2handlingMap;

    /**
     * Fallback handling used when no explicit element handling is configured.
     */
    private ElementHandling defaultOperation = ElementHandling.flatten;

    /**
     * Handling for explicit {@code compile} dependency scopes in the generated POM.
     */
    private ElementHandling compileScope;

    /**
     * Handling for active {@code build/plugins} in the generated POM.
     */
     ...
     * The constructor.
     */
    public GroomDescriptor() {
        super();
        this.name2handlingMap = new HashMap<>();
    }

    /**
     * Returns all explicitly configured element handling values.
     *
     * @return an unmodifiable map of element handling values keyed by POM element name
     */
     ...
     */
    public GroomDescriptor(Xpp3Dom descriptor) {
        this();
        ...
        this.compileScope = getOptionalHandling(descriptor, "compileScope");
        this.buildPlugins = getOptionalHandling(descriptor, "buildPlugins");
    }

    /**
     * Reads an optional element handling child value from the raw descriptor.
     *
     * @param descriptor the raw {@code pomElements} descriptor
     * @param name       the child element name
     * @return the configured element handling, or {@code null} when the child is absent
     */
    private static ElementHandling getOptionalHandling(Xpp3Dom descriptor, String name) {
        Xpp3Dom child = descriptor.getChild(name);
        if (child == null) {
            return null;
        }
        String value = child.getValue();
    ...
    /**
     * Returns the fallback handling used for elements without explicit configuration.
     *
     * @return the fallback element handling
     */
    ...
    /**
     * Configures the fallback handling used for elements without explicit configuration.
     *
     * @param defaultOperation the fallback element handling
     */
    ...
    /**
     * Returns handling for explicit {@code compile} dependency scopes.
     *
     * @return the configured compile scope handling, or {@code null} when absent
     */
    public ElementHandling getCompileScope() {
        return compileScope;
    }

    /**
     * Configures handling for explicit {@code compile} dependency scopes.
     *
     * @param compileScope the compile scope handling
     */
    public void setCompileScope(ElementHandling compileScope) {
        this.compileScope = compileScope;
    }

    /**
     * Tests whether explicit {@code compile} dependency scopes should be removed from the generated POM.
     *
     * @return {@code true} when compile dependency scopes should be removed
     */
    public boolean isCompileScopeRemoved() {
        return compileScope == ElementHandling.remove;
    }

    /**
     * Returns handling for active {@code build/plugins}.
     *
     * @return the configured active build plugin handling, or {@code null} when absent
     */
    public ElementHandling getBuildPlugins() {
        return buildPlugins;
    }

    /**
     * Configures handling for active {@code build/plugins}.
     *
     * @param buildPlugins the active build plugin handling
     */
    public void setBuildPlugins(ElementHandling buildPlugins) {
        this.buildPlugins = buildPlugins;
    }

    /**
     * Tests whether active {@code build/plugins} should be removed from the generated POM.
     *
     * @return {@code true} when active build plugins should be removed
     */
    public boolean isBuildPluginsRemoved() {
        return buildPlugins == ElementHandling.remove;
    }
    ...
    /**
     * Generic method to set an {@link ElementHandling} by raw POM element name.
     *
     * @param name     the POM element name
     * @param handling the new {@link ElementHandling}
     */
    public void setHandling(String name, ElementHandling handling) {

        this.name2handlingMap.put(name, handling);
    }

    /**
     * Returns handling for the artifactId element.
     *
    ...
    /**
     * Configures handling for the artifactId element.
     *
    ...
    /**
     * Returns handling for the groupId element.
     *
    ...
    /**
     * Configures handling for the groupId element.
     *
    ...
    /**
     * Returns handling for the packaging element.
     *
    ...
    /**
     * Configures handling for the packaging element.
     *
    ...
    /**
     * Returns handling for the name element.
     *
    ...
    /**
     * Configures handling for the name element.
     *
    ...
    /**
     * Returns handling for the description element.
     *
    ...
    /**
     * Configures handling for the description element.
     *
    ...
    /**
     * Returns handling for the URL element.
     *
    ...
    /**
     * Configures handling for the URL element.
     *
    ...
    /**
     * Returns handling for the inceptionYear element.
     *
    ...
    /**
     * Configures handling for the inceptionYear element.
     *
    ...
    /**
     * Returns handling for the organization element.
     *
    ...
    /**
     * Configures handling for the organization element.
     *
    ...
    /**
     * Returns handling for the scm element.
     *
    ...
    /**
     * Configures handling for the scm element.
     *
    ...
    /**
     * Returns handling for the prerequisites element.
     *
    ...
    /**
     * Configures handling for the prerequisites element.
     *
    ...
    /**
     * Returns handling for the developers element.
     *
    ...
    /**
     * Configures handling for the developers element.
     *
    ...
    /**
     * Returns handling for the contributors element.
     *
    ...
    /**
     * Configures handling for the contributors element.
     *
    ...
    /**
     * Returns handling for the mailingLists element.
     *
    ...
    /**
     * Configures handling for the mailingLists element.
     *
    ...
    /**
     * Returns handling for the repositories element.
     *
    ...
    /**
     * Configures handling for the repositories element.
     *
    ...
    /**
     * Returns handling for the pluginManagement element.
     *
    ...
    /**
     * Configures handling for the pluginManagement element.
     *
    ...
    /**
     * Returns handling for the pluginRepositories element.
     *
    ...
    /**
     * Configures handling for the pluginRepositories element.
     *
    ...
    /**
     * Returns handling for the issueManagement element.
     *
    ...
    /**
     * Configures handling for the issueManagement element.
     *
    ...
    /**
     * Returns handling for the ciManagement element.
     *
    ...
    /**
     * Configures handling for the ciManagement element.
     *
    ...
    /**
     * Returns handling for the distributionManagement element.
     *
    ...
    /**
     * Configures handling for the distributionManagement element.
     *
    ...
    /**
     * Returns handling for the dependencyManagement element.
     *
    ...
    /**
     * Configures handling for the dependencyManagement element.
     *
    ...
    /**
     * Returns handling for the build element.
     *
    ...
    /**
     * Configures handling for the build element.
     *
    ...
    /**
     * Returns handling for the parent element.
     *
    ...
    /**
     * Configures handling for the parent element.
     *
    ...
    /**
     * Returns handling for the modules element.
     *
    ...
    /**
     * Configures handling for the modules element.
     *
    ...
    /**
     * Returns handling for the properties element.
     *
    ...
    /**
     * Configures handling for the properties element.
     *
    ...
    /**
     * Returns handling for the reporting element.
     *
    ...
    /**
     * Configures handling for the reporting element.
     *
    ...
    /**
     * Returns handling for the dependencies element.
     *
    ...
    /**
     * Configures handling for the dependencies element.
     *
    ...
    /**
     * Returns handling for the profiles element.
     *
    ...
    /**
     * Configures handling for the profiles element.
     *
    ...
    /**
     * Returns handling for the version element.
     *
    ...
    /**
     * Configures handling for the version element.
     *
    ...
    /**
     * Creates and returns a new {@link GroomDescriptor} with the {@link ElementHandling}s merged from this and the
     * given {@link GroomDescriptor}.
     *
     * @param descriptor is the {@link GroomDescriptor} to merge with this one.
     * @return the merged {@link GroomDescriptor}.
     */
    public GroomDescriptor merge(GroomDescriptor descriptor) {
        GroomDescriptor result = new GroomDescriptor();
        for (PomProperty<?> property : PomProperty.getPomProperties()) {
        ...
        result.compileScope = this.compileScope == null ? descriptor.compileScope : this.compileScope;
        result.buildPlugins = this.buildPlugins == null ? descriptor.buildPlugins : this.buildPlugins;
        return result;
    }

    /**
     * Tests whether this descriptor has no explicit element handling values.
     *
     * @return <code>true</code> if none of the properties has been set explicitly, <code>false</code> otherwise.
     */
    public boolean isEmpty() {
        if (compileScope != null || buildPlugins != null) {
            return false;
        }
